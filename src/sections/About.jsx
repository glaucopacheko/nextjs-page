      ...
      <div className='container mx-auto'>
        <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen'>
          ...
          <motion.div variants={fadeIn('left', 0.5)} initial="hidden" whileInView={'show'} viewport={{once: false, amount: 0.3}} className='flex-1'>
            ...
            <h2 className='h2 text-white'>Sobre mim.</h2>
            <h3 className='h3 mb-4'>Sou Desenvolvedor Front-end Freelancer com mais de 3 anos de experiência</h3>
            <p className='mb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita officiis, voluptatem dignissimos eos hic laboriosam eum a nisi, assumenda explicabo rem. Odio eveniet excepturi facere ipsam, tempore quod repellendus neque?</p>
            
            <div className='flex gap-x-6 lg:gap-x-10 mb-12'>

              <div>
                <div className='text-[40px] font-tertiary text-gradient mb-2 pt-4'>
