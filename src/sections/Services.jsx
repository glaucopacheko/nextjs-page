...
const services = [
  {
    name: 'UI/UX Design',
    description: 'Consequuntur recusandae aliquam ad accusantium consectetur nulla sapiente sequi.',
    link: 'Learn more'
  },
  {
    name: 'Development',
      ...
      <div className='container mx-auto'>
        <div className='flex flex-col lg:flex-row'>
          ...
          <motion.div  variants={fadeIn('right', 0.3)} initial="hidden" whileInView={'show'} viewport={{once: false, amount: 0.3}} className='flex-1 lg:bg-services lg:bg-bottom bg-no-repeat mix-blend-lighten mb-12 lg:mb-0'>
            ...
            <h3 className='h3 max-w-[455px] mb-16'>I'm a Freelance Front-en Developer with over 3 years of experience</h3>
